...
# this file taken from Text-ParseWords-3.29/t/ParseWords.t on CPAN.
...
$Fink::Text::ParseWords::PERL_SINGLE_QUOTE = 1;
$string = 'aaaa"bbbbb" cc\ cc \\\\\"dddd\' eee\\\\\"\\\'ffff\' gg';
$result = join('|', parse_line('\s+', 0, $string));
is($result, 'aaaabbbbb|cc cc|\"dddd eee\\\\"\'ffff|gg');
...
# [perl #30442] Fink::Text::ParseWords does not handle backslashed newline inside quoted text
...
alarm(3);
@words = Fink::Text::ParseWords::old_shellwords("foo\\");
is(@words, 1);
alarm(0);
