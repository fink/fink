...
sub system_check {
	...
	if (not Fink::VirtPackage->query_package("dev-tools")) {
		warn "Before changing your selfupdate method to 'git', you must install XCode, available on your original OS X install disk, or from http://connect.apple.com (after free registration).\n";
		return 0;
	}
