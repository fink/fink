# This file is based on Tie::Watch v1.1 from CPAN.
# It was converted to Fink::Tie::Watch and further modified 
# for use by Fink. You can read about these changes in the accompanying
# ChangeLog files and by browsing the CVS repository.

$Fink::Tie::Watch::VERSION = '1.1';

package Fink::Tie::Watch;

=head1 NAME

 Fink::Tie::Watch - place watchpoints on Perl variables.

=head1 SYNOPSIS

 use Fink::Tie::Watch;

 $watch = Fink::Tie::Watch->new(
     -variable => \$frog,
     -debug    => 1,
     -shadow   => 0,			  
...
Fink::Tie::Watch provides default callbacks for any that you fail to
...
=item $watch = Fink::Tie::Watch->new(-options => values);
...
prevent infinite recursion Fink::Tie::Watch maintains parallel variables for
...
sub new {
    ...
    # Watch constructor.  The *real* constructor is
    # Fink::Tie::Watch->base_watch(),
    ...
    my($class, %args) = @_;
    my $version = $Fink::Tie::Watch::VERSION;
    my (%arg_defaults) = (-debug => 0, -shadow  => 1);
    my $variable = $args{-variable};
    croak "Fink::Tie::Watch::new(): -variable is required."
    	if not defined $variable;

    my($type, $watch_obj) = (ref $variable, undef);
    if ($type =~ /(SCALAR|REF)/) {
	@arg_defaults{@scalar_callbacks} = (
	    [\&Fink::Tie::Watch::Scalar::Destroy],
	    [\&Fink::Tie::Watch::Scalar::Fetch],
	    [\&Fink::Tie::Watch::Scalar::Store]);
    } elsif ($type =~ /ARRAY/) {
	@arg_defaults{@array_callbacks}  = (
	    [\&Fink::Tie::Watch::Array::Clear],
	    [\&Fink::Tie::Watch::Array::Destroy],
	    [\&Fink::Tie::Watch::Array::Extend],
	    [\&Fink::Tie::Watch::Array::Fetch],
	    [\&Fink::Tie::Watch::Array::Fetchsize],
	    [\&Fink::Tie::Watch::Array::Pop],
        [\&Fink::Tie::Watch::Array::Push],
        [\&Fink::Tie::Watch::Array::Shift],
        [\&Fink::Tie::Watch::Array::Splice],
        [\&Fink::Tie::Watch::Array::Store],
        [\&Fink::Tie::Watch::Array::Storesize],
        [\&Fink::Tie::Watch::Array::Unshift]);
    } elsif ($type =~ /HASH/) {
	@arg_defaults{@hash_callbacks}   = (
	    [\&Fink::Tie::Watch::Hash::Clear],
	    [\&Fink::Tie::Watch::Hash::Delete],
	    [\&Fink::Tie::Watch::Hash::Destroy],
	    [\&Fink::Tie::Watch::Hash::Exists],
        [\&Fink::Tie::Watch::Hash::Fetch],
        [\&Fink::Tie::Watch::Hash::Firstkey],
        [\&Fink::Tie::Watch::Hash::Nextkey],
        [\&Fink::Tie::Watch::Hash::Store]);
    } else {
	croak "Fink::Tie::Watch::new() - not a variable reference.";
    }
    ...
    if ($type =~ /(SCALAR|REF)/) {
        $watch_obj = tie $$variable, 'Fink::Tie::Watch::Scalar', %ahsh;
    } elsif ($type =~ /ARRAY/) {
        $watch_obj = tie @$variable, 'Fink::Tie::Watch::Array',  %ahsh;
    } elsif ($type =~ /HASH/) {
        $watch_obj = tie %$variable, 'Fink::Tie::Watch::Hash',   %ahsh;
    }
    $watch_obj;
...
sub Unwatch {
	...
	croak "Fink::Tie::Watch::Delete() - not a variable reference.";
    }
...
sub normalize_callbacks {
	...
	if ($ref =~ /CODE/) {
	    ...
	    croak "Fink::Tie::Watch:  malformed callback $arg=$cb.";
	}
    }
...
package Fink::Tie::Watch::Scalar;

use Carp;
@Fink::Tie::Watch::Scalar::ISA = qw/Fink::Tie::Watch/;

sub TIESCALAR {

    my($class, %args) = @_;
    my $variable = $args{-variable};
    my $watch_obj = Fink::Tie::Watch->base_watch(%args);
...
sub Info {$_[0]->SUPER::Info('-value', @Fink::Tie::Watch::scalar_callbacks)}
...
package Fink::Tie::Watch::Array;

use Carp;
@Fink::Tie::Watch::Array::ISA = qw/Fink::Tie::Watch/;
...
sub Info {$_[0]->SUPER::Info('-ptr', @Fink::Tie::Watch::array_callbacks)}
...
package Fink::Tie::Watch::Hash;

use Carp;
@Fink::Tie::Watch::Hash::ISA = qw/Fink::Tie::Watch/;
...
sub Info {$_[0]->SUPER::Info('-ptr', @Fink::Tie::Watch::hash_callbacks)}
